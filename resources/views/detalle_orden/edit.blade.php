...
@section('titulo', 'Actualizacion de Detalle Orden')
...
<div class="container-fluid">
	...
	<div class="row clearfix">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="header">
					<h2 class="text-center">ACTUALIZACION DE DETALLE ORDEN</h2>
				</div>

				<div class="body">

					<form class="form-horizontal" id="form_validation" method="POST"
						action="{{ route('empleadoorden.update', $empleadoorden->id) }}" autocomplete="off">
						...
						<div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7" data-toggle="modal"
								...
								<div class="form-group">
                                    ...
                                    readonly="readonly" required value="{{$empleadoorden->empleado_id}}">
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									<div class="form-line">
										<select class="form-control show-tick" data-live-search="true" name="orden_id"
                                            ...
                                            @if($orden->id == $empleadoorden->orden_id)
                                            <option value="{{$orden->id}}" selected>{{$orden->nombre}}</option>
                                            @else
						...
						<div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
								<div class="form-group">
									<div class="form-line">
                                    <input type="text" class="form-control" id="cantidad" name="cantidad" value="{{$empleadoorden->cantidad}}">
									</div>
								</div>
							</div>
                        </div>
                        ...
                        <div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
								<div class="form-group">
									<div class="form-line">
                                    <input type="text" class="form-control" id="estado" name="estado" value="{{$empleadoorden->estado}}">
									</div>
								</div>
							</div>
						</div>
