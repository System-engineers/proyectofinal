...
@section('titulo', 'Detalle Orden Empleado')
			...
			<div class="card">
				<div class="header">
					<h2 class="text-center">
						LISTA DE DETALLE ORDEN
					</h2>
					<a href="{{route('empleadoorden.create')}}"
						...
						<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$empleadoorden->empleado->nombres}}</td>
									<td>
										{{$empleadoorden->orden->nombre}}
									</td>
									<td class="text-center">
										<a href="{{route('empleadoorden.edit', $empleadoorden->id)}}"
									...
									<td class="text-center">
										<form action="{{route('empleadoorden.destroy', $empleadoorden->id)}}" method="POST">
											@csrf
											@method('DELETE')
