...
<div class="container-fluid">
	...
	<div class="row clearfix">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="header">
					<h2 class="text-center">ACTUALIZACION DE ORDENES</h2>
				</div>

				<div class="body">

					<form class="form-horizontal" id="form_validation" method="POST"
						action="{{ route('orden.update', $orden->id) }}" autocomplete="off">
                        ...
                        <div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7" data-toggle="modal"
								...
								<div class="form-group">
                                    ...
                                    readonly="readonly" required value="{{$orden->cliente_id}}">
									</div>
								</div>
							</div>
						</div>
                        ...
                        <div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
								<div class="form-group">
									<div class="form-line">
										<input type="text" class="form-control" id="detalle" name="detalle" value="{{$orden->detalle}}">
									</div>
								</div>
							</div>
						</div>
                        ...
                        <div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
								<div class="form-group">
									<div class="form-line">
										<input type="date" class="form-control" id="fecha_entrada" name="fecha_entrada" value="{{$orden->fecha_entrada}}">
									</div>
								</div>
							</div>
                        </div>
                        ...
                        <div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
								<div class="form-group">
									<div class="form-line">
										<input type="date" class="form-control" id="fecha_salida" name="fecha_salida" value="{{$orden->fecha_salida}}">
									</div>
								</div>
							</div>
                        </div>
						...
						<div class="row clearfix text-center">
							<div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
								...
								<a href="{{route('orden.index')}}" class="btn btn-danger waves-effect m-l-35">
