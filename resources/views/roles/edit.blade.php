...
@section('titulo', 'Actualizacion de Roles')
...
<div class="container-fluid">
	...
	<div class="row clearfix">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				<div class="header">
					<h2 class="text-center">ACTUALIZACION DE ROLES</h2>
				</div>


				<div class="body">
					<form class="form-horizontal" id="form_validation" method="POST"
						action="{{ route('roles.update', $role->id) }}" autocomplete="off">
						...
						<div class="col-lg-12">
							...
							<div class="demo-checkbox text-center">
								...
								<div class="col-lg-4">
									@if($encontre==1)
									<input type="checkbox" name="permission[]" class="chk-col-red"
										id="permission-{{$permission->id}}" value="{{$permission->id}}" checked>
